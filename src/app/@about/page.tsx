  ...
  return (
    ...
    >
      <section className="space-y-6">
        ...
        <p>
          also known as <strong>PLMohamed</strong>, I&apos;m a full-stack web
          developer, I have a passion for web development and love to create web
          applications using modern technologies.
        </p>
        <p>
          I have a strong foundation in web development and I&apos;m on a
          journey to evolve into a DevOps , I &apos;m a fast learner and
      ...
      <section className="space-y-4">
        ...
        <div className="relative max-w-full space-y-4">
          <StackWrapper direction="left">
            <Image src="js.svg" width={48} height={48} alt="javascript" />
            <Image src="html.svg" width={48} height={48} alt="html" />
            <Image src="css.svg" width={48} height={48} alt="css" />
            <Image src="nodejs.svg" width={48} height={48} alt="node js" />
            <Image
              src="tailwindcss.svg"
              width={48}
              height={48}
              alt="tailwind css"
            />
            <Image src="react.svg" width={48} height={48} alt="react js" />
            <Image
              src="electron.svg"
              width={48}
              height={48}
              alt="electron js"
            />
            <Image src="nextjs.svg" width={48} height={48} alt="next js" />
            <Image src="mysql.svg" width={48} height={48} alt="mysql" />
            <Image src="python.svg" width={48} height={48} alt="python" />
            <Image src="php.svg" width={48} height={48} alt="php" />
          </StackWrapper>
          <StackWrapper direction="right">
            <Image src="vitejs.svg" width={48} height={48} alt="vite js" />
            <Image
              src="/drizzleorm.png"
              width={48}
              height={48}
            ...
            <Image src="/shadcn.png" width={48} height={48} alt="shadcn" />
            <Image
              src="vscode.svg"
              width={48}
              height={48}
            ...
            />
            <Image src="/markdown.png" width={48} height={48} alt="markdown" />
            <Image src="docker.svg" width={48} height={48} alt="docker" />
            <Image src="insomnia.svg" width={48} height={48} alt="insomnia" />
