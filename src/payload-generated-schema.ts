...
export const enum_footer_nav_items_link_appearance = pgEnum(
  'enum_footer_nav_items_link_appearance',
  ['default', 'outline', 'link'],
)
export const enum_footer_nav_items_icon = pgEnum('enum_footer_nav_items_icon', [])
...
export const pages = pgTable(
  'pages',
  {
    ...
    hero_mediaTwo: integer('hero_media_two_id').references(() => media.id, {
      onDelete: 'set null',
    }),
  ...
  (columns) => ({
    ...
    pages_hero_hero_media_two_idx: index('pages_hero_hero_media_two_idx').on(columns.hero_mediaTwo),
...
export const _pages_v = pgTable(
  '_pages_v',
  {
    ...
    version_hero_mediaTwo: integer('version_hero_media_two_id').references(() => media.id, {
      onDelete: 'set null',
    }),
  ...
  (columns) => ({
    ...
    _pages_v_version_hero_version_hero_media_two_idx: index(
      '_pages_v_version_hero_version_hero_media_two_idx',
    ).on(columns.version_hero_mediaTwo),
...
export const projects_content_images = pgTable(
  'projects_content_images',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('projects_content_images_order_idx').on(columns._order),
    _parentIDIdx: index('projects_content_images_parent_id_idx').on(columns._parentID),
    projects_content_images_image_idx: index('projects_content_images_image_idx').on(columns.image),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [projects.id],
      name: 'projects_content_images_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const projects = pgTable(
  'projects',
  {
    ...
    Content_mainImage: integer('content_main_image_id').references(() => media.id, {
      onDelete: 'set null',
    }),
    Content_projectUrl: varchar('content_project_url'),
    Content_projectSourceUrl: varchar('content_project_source_url'),
    meta_title: varchar('meta_title'),
    meta_image: integer('meta_image_id').references(() => media.id, {
      onDelete: 'set null',
    }),
  ...
  (columns) => ({
    projects_content_content_main_image_idx: index('projects_content_content_main_image_idx').on(
      columns.Content_mainImage,
    ),
...
export const _projects_v_version_content_images = pgTable(
  '_projects_v_version_content_images',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('_projects_v_version_content_images_order_idx').on(columns._order),
    _parentIDIdx: index('_projects_v_version_content_images_parent_id_idx').on(columns._parentID),
    _projects_v_version_content_images_image_idx: index(
      '_projects_v_version_content_images_image_idx',
    ).on(columns.image),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_projects_v.id],
      name: '_projects_v_version_content_images_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const _projects_v = pgTable(
  '_projects_v',
  {
    ...
    version_title: varchar('version_title'),
    version_Content_description: jsonb('version_content_description'),
    version_Content_mainImage: integer('version_content_main_image_id').references(() => media.id, {
      onDelete: 'set null',
    }),
    version_Content_projectUrl: varchar('version_content_project_url'),
    version_Content_projectSourceUrl: varchar('version_content_project_source_url'),
    version_meta_title: varchar('version_meta_title'),
    version_meta_image: integer('version_meta_image_id').references(() => media.id, {
      onDelete: 'set null',
    }),
  ...
  (columns) => ({
    ...
    _projects_v_version_content_version_content_main_image_idx: index(
      '_projects_v_version_content_version_content_main_image_idx',
    ).on(columns.version_Content_mainImage),
...
export const footer_nav_items = pgTable(
  'footer_nav_items',
  {
    ...
    link_url: varchar('link_url'),
    link_label: varchar('link_label').notNull(),
    link_appearance: enum_footer_nav_items_link_appearance('link_appearance').default('default'),
    icon: enum_footer_nav_items_icon('icon'),
  },
  (columns) => ({
...
export const relations_pages = relations(pages, ({ one, many }) => ({
  ...
  hero_mediaTwo: one(media, {
    fields: [pages.hero_mediaTwo],
    references: [media.id],
    relationName: 'hero_mediaTwo',
  }),
...
export const relations__pages_v = relations(_pages_v, ({ one, many }) => ({
  ...
  version_hero_mediaTwo: one(media, {
    fields: [_pages_v.version_hero_mediaTwo],
    references: [media.id],
    relationName: 'version_hero_mediaTwo',
  }),
...
export const relations_projects_content_images = relations(projects_content_images, ({ one }) => ({
  _parentID: one(projects, {
    fields: [projects_content_images._parentID],
    references: [projects.id],
    relationName: 'Content_images',
  }),
  image: one(media, {
    fields: [projects_content_images.image],
    references: [media.id],
    relationName: 'image',
  }),
}))
export const relations_projects = relations(projects, ({ one, many }) => ({
  Content_mainImage: one(media, {
    fields: [projects.Content_mainImage],
    references: [media.id],
    relationName: 'Content_mainImage',
  }),
  Content_images: many(projects_content_images, {
    relationName: 'Content_images',
  }),
  meta_image: one(media, {
...
export const relations__projects_v_version_content_images = relations(
  _projects_v_version_content_images,
  ({ one }) => ({
    _parentID: one(_projects_v, {
      fields: [_projects_v_version_content_images._parentID],
      references: [_projects_v.id],
      relationName: 'version_Content_images',
    }),
    image: one(media, {
      fields: [_projects_v_version_content_images.image],
      references: [media.id],
      relationName: 'image',
    }),
  }),
...
export const relations__projects_v = relations(_projects_v, ({ one, many }) => ({
  ...
  version_Content_mainImage: one(media, {
    fields: [_projects_v.version_Content_mainImage],
    references: [media.id],
    relationName: 'version_Content_mainImage',
  }),
  version_Content_images: many(_projects_v_version_content_images, {
    relationName: 'version_Content_images',
  }),
  version_meta_image: one(media, {
...
type DatabaseSchema = {
  ...
  enum_footer_nav_items_link_appearance: typeof enum_footer_nav_items_link_appearance
  enum_footer_nav_items_icon: typeof enum_footer_nav_items_icon
  ...
  projects_content_images: typeof projects_content_images
  projects: typeof projects
  _projects_v_version_content_images: typeof _projects_v_version_content_images
  ...
  relations_projects_content_images: typeof relations_projects_content_images
  relations_projects: typeof relations_projects
  relations__projects_v_version_content_images: typeof relations__projects_v_version_content_images
